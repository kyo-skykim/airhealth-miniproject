...
# MAGIC MLflow, and writes predictions back to `airhealth.gold.*`.
...
# COMMAND ----------
display(spark.table("airhealth.gold.mart_pm25_forecast"))  # noqa: F821
# COMMAND ----------
display(spark.table("airhealth.gold.mart_asthma_predictions"))  # noqa: F821
